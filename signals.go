...
// handle Unix signals. For exampke, we might want a server
...
func main() {
  ...
  // notifications (we'll also make one to notify us when the
  // program can exit)
  ...
  // When it gets one, it'll print out and the nnotify the
